...
const SUPABASE_ANON_KEY =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRodWl4ZW9pdm1ubWpxYXp0ZWt3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTM0MDIwNDQsImV4cCI6MjA2ODk3ODA0NH0.2OdCMtbEWdpWBbrPzKpYqRZ4LWfW20AQPWSSK6EQEu0';
...
export const testConnection = async () => {
  ...
  try {
    ...
    if (error) {
      console.log(
        '🤔 Got error (this might be normal):',
        error.code,
        error.message,
      );
      ...
      if (
        ...
        console.log(
          '✅ Connection successful! (Table not found is expected before DB setup)',
        );
        return true;
      }
      ...
      if (error.code === 'PGRST301' || error.message.includes('permission')) {
        console.log(
          '✅ Connection successful! (Permission denied is expected with RLS)',
        );
        return true;
      }
